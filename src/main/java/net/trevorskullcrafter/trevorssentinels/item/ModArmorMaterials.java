...
public enum ModArmorMaterials implements ModArmorMaterial {
	...
	SCRAP_METAL("scrap_metal", 3, Util.make(new EnumMap<>(ArmorItem.ArmorSlot.class),
		...
		8, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 0.0f, 0.0f, () -> Ingredient.ofItems(TechItems.SCRAP_METAL_SHARD), ModEffects.SET_BONUS_SCRAP_METAL),
	...
	ROSE_GOLD("rose_gold", 8, Util.make(new EnumMap<>(ArmorItem.ArmorSlot.class),
		...
		7, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0f, 0.0f, () -> Ingredient.ofItems(MagicItems.ROSE_GOLD_INGOT), ModEffects.SET_BONUS_ROSE_GOLD),
	...
	STARSTEEL("starsteel", 27, Util.make(new EnumMap<>(ArmorItem.ArmorSlot.class),
		...
		4, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 0.5f, 0.1f, () -> Ingredient.ofItems(TechItems.STARSTEEL_INGOT), ModEffects.SET_BONUS_STARSTEEL),
	...
	IMPERIAL("imperial", 24, Util.make(new EnumMap<>(ArmorItem.ArmorSlot.class),
		...
		4, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.5f, 0.1f, () -> Ingredient.ofItems(MagicItems.IMPERIAL_ALLOY_INGOT), ModEffects.SET_BONUS_IMPERIAL),
    ...
    UNHOLY("unholy", 39, new int[]{4, 8, 10, 4}, 17, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.5f, 0.4f,
		() -> Ingredient.ofItems(MagicItems.UNHOLY_INGOT), ModEffects.SET_BONUS_UNHOLY),

    NUCLEAR("nuclear", 39, new int[]{4, 8, 10, 4}, 0, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 3.5f, 0.4f,
		() -> Ingredient.ofItems(TechItems.NUCLEAR_INGOT), ModEffects.SET_BONUS_NUCLEAR),

    ARMA_DEI("arma_dei", 42, new int[]{5, 8, 12, 6}, 20, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.5f, 0.4f,
		() -> Ingredient.ofItems(Items.GOLD_INGOT), ModEffects.SET_BONUS_ARMA_DEI),

    NANOTECH("nanotech", 42, new int[]{5, 8, 12, 6}, 0, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 3.5f, 0.4f,
		() -> Ingredient.ofItems(TechItems.NANOTECH_CAPSULE), ModEffects.SET_BONUS_NANOTECH),

    ZENITHIUM("zenithium", 47, new int[]{7, 10, 14, 8}, 10, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 5f, 0.6f,
		() -> Ingredient.ofItems(TechItems.ZENITHIUM_CLUSTER), ModEffects.SET_BONUS_ZENITHIUM);
